  ...
  return (
    <div className="min-h-screen bg-white text-[#0b0f0d]">
      ...
      <main id="top">
        ...
        {/* プロテスト（セレクション）サービス */}
        <section id="protest" className="bg-[#fafaf7] py-20">
          <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
            <p className="eyebrow">NEW SERVICE</p>
            <h2 className="section-title mt-2">プロテスト（入団テスト）サポート</h2>
            <p className="section-subtitle">
              現地クラブの入団テスト（プロテスト／セレクション）への挑戦をサポート。プロ契約・上位カテゴリ昇格を本気でめざす選手向けの新サービスです。
            </p>

            <div className="mt-10 overflow-hidden rounded-2xl border border-[#0a4f2a]/20 bg-gradient-to-br from-[#0b0f0d] via-[#0a3a1f] to-[#0a4f2a] text-white shadow-sm">
              <div className="grid gap-8 p-8 sm:p-10 md:grid-cols-2">
                <div className="flex flex-col justify-center">
                  <span className="inline-flex w-fit items-center gap-2 rounded-full border border-white/20 bg-white/5 px-4 py-1.5 text-[10px] font-bold tracking-[0.2em] text-white/80">
                    <span className="h-1.5 w-1.5 rounded-full bg-[#ffcd00]" />
                    PRO TEST / SELECTION
                  </span>
                  <h3 className="mt-5 text-2xl font-extrabold leading-snug sm:text-3xl">
                    現地クラブの入団テストへ、
                    <br />
                    <span className="text-[#ffcd00]">本気の挑戦を。</span>
                  </h3>
                  ...
                  <div className="mt-6 flex flex-wrap gap-3">
                    <div className="rounded-xl border border-white/15 bg-white/5 px-4 py-3">
                      <p className="text-[10px] font-bold tracking-[0.15em] text-[#ffcd00]">期間</p>
                      <p className="mt-1 text-base font-bold">2週間〜</p>
                    </div>
                    <div className="rounded-xl border border-white/15 bg-white/5 px-4 py-3">
                      <p className="text-[10px] font-bold tracking-[0.15em] text-[#ffcd00]">受験クラブ数</p>
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <ul className="space-y-3 text-sm">
                    {[
                      ...
                      <li key={point} className="flex items-start gap-3 rounded-xl bg-white/5 px-4 py-3">
                        <span className="mt-1.5 inline-block h-1.5 w-1.5 flex-shrink-0 rounded-full bg-[#ffcd00]" />
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mt-2 inline-flex w-full items-center justify-center gap-2 rounded-full bg-[#06C755] px-5 py-3.5 text-sm font-bold text-white transition hover:bg-[#05b34c]"
                  >
                    <svg viewBox="0 0 24 24" className="h-4 w-4" fill="currentColor" aria-hidden="true"><path d="M19.365 9.863c.349 0 .63.285.63.631 0 .345-.281.63-.63.63H17.61v1.125h1.755c.349 0 .63.283.63.63 0 .344-.281.629-.63.629h-2.386c-.345 0-.627-.285-.627-.629V8.108c0-.345.282-.63.63-.63h2.386c.346 0 .627.285.627.63 0 .349-.281.63-.63.63H17.61v1.125h1.755zm-3.855 3.016c0 .27-.174.51-.432.596-.064.021-.133.031-.199.031-.211 0-.391-.09-.51-.25l-2.443-3.317v2.94c0 .344-.279.629-.631.629-.346 0-.626-.285-.626-.629V8.108c0-.27.173-.51.43-.595.06-.023.136-.033.194-.033.195 0 .375.104.495.254l2.462 3.33V8.108c0-.345.282-.63.63-.63.345 0 .63.285.63.63v4.771zm-5.741 0c0 .344-.282.629-.631.629-.345 0-.627-.285-.627-.629V8.108c0-.345.282-.63.63-.63.346 0 .628.285.628.63v4.771zm-2.466.629H4.917c-.345 0-.63-.285-.63-.629V8.108c0-.345.285-.63.63-.63.348 0 .63.285.63.63v4.141h1.756c.348 0 .629.283.629.63 0 .344-.281.629-.629.629M24 10.314C24 4.943 18.615.572 12 .572S0 4.943 0 10.314c0 4.811 4.27 8.842 10.035 9.608.391.082.923.258 1.058.59.12.301.079.766.038 1.08l-.164 1.02c-.045.301-.24 1.186 1.049.645 1.291-.539 6.916-4.078 9.436-6.975C23.176 14.393 24 12.458 24 10.314"/></svg>
                    プロテストについて相談する
                  </a>
