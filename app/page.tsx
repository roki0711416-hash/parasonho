      ...
      <main id="top">
        ...
        <section id="plans" className="bg-white py-16">
          <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
              ...
              {plans.map((plan) => (
                <article key={plan.title} className="card flex h-full flex-col">
                  ...
                  <div className="mt-6 border-t border-[#d6e9c9] pt-5">
                    <p className="text-xs font-semibold uppercase tracking-widest text-[#4e8a3d]">費用目安</p>
                    <p className="mt-1 text-2xl font-extrabold text-[#0b6a37]">{plan.price}</p>
                  </div>
                  <a
                    href={LINE_URL}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mt-5 inline-flex items-center justify-center gap-2 rounded-full bg-[#06C755] px-5 py-3 text-sm font-bold text-white transition hover:bg-[#05b34c]"
                  >
            ...
            <p className="mt-6 text-center text-xs text-[#456c54]">※航空券・ビザ費用は別途</p>
          </div>
        </section>
